# Setup database without password (requires trust mode)

$psqlPath = "C:\Program Files\PostgreSQL\18\bin\psql.exe"
$dataDir = "C:\Program Files\PostgreSQL\18\data"

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "PostgreSQL Database Setup (No Password)" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
if ($userCheck -match "1") {
    ...
    if ($LASTEXITCODE -eq 0) {
        ...
        Write-Host "  -> Make sure trust mode is enabled. Run setup_trust_mode.ps1 first." -ForegroundColor Yellow
        exit 1
    }
}
